...
const Login = () => {
  ...
  return (
    <div className="flex justify-center items-center min-h-[calc(100vh-140px)] py-10 px-4">
      <div className="bg-white/90 backdrop-blur-xl border border-white/40 shadow-2xl rounded-3xl p-8 w-full max-w-md">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-5">
          ...
          <button
            type="submit"
            className="mt-4 w-full py-3.5 rounded-xl bg-gradient-to-r from-blue-500 to-indigo-600 text-white font-bold text-lg hover:shadow-lg hover:-translate-y-0.5 transition-all duration-300 focus:outline-none focus:ring-4 focus:ring-blue-300"
          >
            Sign In
          </button>
        </form>
